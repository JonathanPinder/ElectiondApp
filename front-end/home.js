...
candidates = {"Joe Biden": "candidate-1", "Donald Trump": "candidate-2", "Barrack Obama": "candidate-3"}
...
//$(document).ready(function(){
  //$("#cname1, #cname2, #cname3").click(function(){
  //$("#t1 td").click(function(){
  	//$(this).addClass('selected').siblings().removeClass('selected');    
   //var value=$(this).find('td:first').html();
   //document.getElementById("candidate").value = this.cells[0].innerHTML;
    //alert("Text: " + $("#cname").attr(td));
 // });
//});
...
$("input:radio").change(function() {
  if($(this).is(":checked")) {
    ...
    var col2 = col1.next();
    document.getElementById("candidate").value = this.col2.innerHTML;
};
});